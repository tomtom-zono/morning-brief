...
各記事は3部構成。字数は機械検証され、満たさない記事は最大3回まで自動再生成される。
...
各記事と米国市場概況には、日本語本文の下に英語版(English Version)が表示される。
機関投資家が実際に使う金融英語での翻訳を Flash モデルで生成しており、
英語学習を兼ねた対訳として読める。翻訳に失敗した記事は日本語のみで公開される。
